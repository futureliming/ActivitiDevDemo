...
public class ModelerController{
    ...
    private  final Logger logger = LoggerFactory.getLogger(ModelerController.class);
...
//    @ResponseBody
	...
	public String index(ModelMap model, HttpServletRequest request) {
		...
		model.addAttribute("modelList",repositoryService.createModelQuery().list());
...
//	@ResponseBody
	...
	public Object deleteProcessModel(String modelId){
		logger.info("删除流程模型入参modelId：{}",modelId);
		Map<String, String> map = new HashMap<String, String>();
		Model modelData = repositoryService.getModel(modelId);
		if(null != modelData){
			try {
